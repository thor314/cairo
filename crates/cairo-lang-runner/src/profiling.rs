...
impl<'a> ProfilingInfoProcessor<'a> {
    ...
    pub fn process_ex(
        ...
        // TODO(yg): remove, do similar to cairo_functions.
        ...
        // TODO(yg): split to parts: collect libfunc info (inc. return), collect user functions info
        // etc. For this, extract this iterator, and clone it a few times (make sure only the
        // iterator is cloned). Then return_weight should not be mut.
